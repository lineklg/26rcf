...
# Prefer the installed Arm GNU Toolchain 15.3.1. Override ARM_GCC_ROOT when
# configuring on another machine or with a different toolchain installation.
set(ARM_GCC_ROOT "C:/Program Files/Arm/GNU Toolchain mingw-w64-x86_64-arm-none-eabi"
...
if(EXISTS "${ARM_GCC_ROOT}/bin/arm-none-eabi-gcc.exe")
    ...
    message(FATAL_ERROR
        "Arm GNU Toolchain not found at '${ARM_GCC_ROOT}'. "
        "Set ARM_GCC_ROOT to the installation directory.")
endif()
